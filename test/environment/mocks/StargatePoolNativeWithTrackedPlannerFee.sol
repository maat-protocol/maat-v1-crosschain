...
import {MessagingFee, StargatePool, Transfer} from "@stargatefinance/stg-evm-v2/src/StargatePool.sol";
import {MessagingReceipt, Ticket} from "@stargatefinance/stg-evm-v2/src/interfaces/IStargate.sol";
import {StargatePoolNative} from "@stargatefinance/stg-evm-v2/src/StargatePoolNative.sol";
import {SendParam} from "@stargatefinance/stg-evm-v2/src/StargatePool.sol";
...
contract StargatePoolNativeWithTrackedPlannerFee is StargatePoolNative {
    ...
    function _rideBus(
        ...
        internal
        override
        returns (MessagingReceipt memory receipt, Ticket memory ticket)
    {
        (receipt, ticket) = super._rideBus(
            _sendParam,
            _messagingFee,
            _amountSD,
            _refundAddress
